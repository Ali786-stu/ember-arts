...
const socials = [
  { 
    name: "Instagram", 
    href: "https://instagram.com/laxmii_2004", 
    icon: (
  ...
  { 
    ...
    icon: (
      <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
        <path d="M12 24C5.385 24 0 18.615 0 12S5.385 0 12 0s12 5.385 12 12-5.385 12-12 12zm10.12-10.358c-.35-.11-3.17-.953-6.384-.438 1.34 3.684 1.887 6.684 1.992 7.308 2.722-1.46 4.693-4.143 5.108-7.31zM15.196 21.62c-.155-.904-.767-4.043-2.23-7.75l-.093.028c-4.75 1.488-6.39 6.42-6.492 6.743 1.63.93 3.51 1.462 5.51 1.462 1.18 0 2.312-.182 3.376-.514-.027-.01-.044-.02-.07-.03zm-10.75-2.03c.128-.348 2.355-6.07 7.055-7.332.14-.04.284-.075.427-.107-.123-.275-.253-.55-.385-.827-4.622.126-9.153 1.342-9.52 1.442.26 2.507 1.253 4.77 2.802 6.556l-.38-.032zM1.13 11.09c.492-.124 5.388-1.346 9.49-1.2l-.333-.733C8.245 4.764 6.166 1.443 5.922 1.07 3.11 2.49 1.15 5.337 1.13 8.652c0 .824.085 1.63.245 2.41l-.245.028zm6.512-9.034c.264.385 2.42 3.56 4.475 7.95l.17.375c1.353-.524 4.098-1.405 7.15-1.127-.852-2.316-2.583-4.214-4.78-5.3-.343.342-2.21 2.316-3.834 5.09-.007.01-.013.02-.02.03-1.31-2.484-2.47-5.023-2.61-5.328l-.55-.022zM20.09 5.433c-2.906-.328-5.46.395-6.83.953 1.385 2.76 2.573 5.56 3.102 6.892 3.033-.422 5.56.342 5.64.366-.1-.322-.05-3.328-1.912-6.52l-.01-.012z" />
      </svg>
    ), 
    color: "hover:text-[#EA4C89] hover:bg-[#EA4C89]/10 hover:border-[#EA4C89]/30" 
  },
];
